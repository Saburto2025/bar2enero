    ...
    <header className="sticky top-0 z-50 bg-slate-900/90 backdrop-blur-md border-b border-amber-500/20 shadow-2xl">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-20">
          ...
          {/* LOGO & BRANDING */}
          <div className="flex items-center space-x-3 cursor-pointer" onClick={() => setActiveTab('caja')}>
            ...
            <div>
              ...
              <p className="text-xs text-slate-400 font-medium">Sistema Integrado Caja ⟷ Cocina</p>
            </div>
          </div>
          ...
          <nav className="flex items-center space-x-1 sm:space-x-2">
            ...
            <button
              ...
              title="Ver dirección IP para conectar la 2da computadora"
            >
